        ...
        <div class="container p-4">
            ...
            <div class="row bg-gray p-3">
                <div class="col-sm-12 col-md-8 col-lg-8 pb-3">
                    <p class="main-text mb-2 mt-2 mb-3">Arrange your ideal studio and get early feedback</p>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4  pb-3 text-center">
                    <div class="mt-3 mb-2">
                        <svg class="bi bi-caret-right-square" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="row mt-5">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div>
                        ...
                        <div class="mb-3 mt-4">
                            <h6 class="text-bold">Equipment can be easy.</h6>
                        ...
                        <div class="mb-4">
                            <h6 class="text-bold">Students need to hear you.</h6>
                        ...
                        <div class="mb-4">
                            <h6 class="text-bold">Make a studio.</h6>
                        ...
                        <div class="mb-4">
                            <h6 class="text-bold">Light the scene and your face.</h6>
                        ...
                        <div class="mb-4">
                            <h6 class="text-bold">Reduce noise and echo.</h6>
                        ...
                        <div class="mb-5">
                            <h6 class="text-bold">Be creative.</h6>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            <div class="mb-3">
                                <a href="#"><h6 class=" text-bold">Teach Hub: Guide to equipment</h6></a>
                                <p>
