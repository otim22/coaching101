        ...
        <div class="row d-flex justify-content-center">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="d-flex justify-content-end mb-4">
                    <div class="mr-3">
                        <h1><span  id="timer" data-timer="120"></span></h1>
                    </div>
                    <div>
                                    ...
                                    @foreach($quizQuestion->options as $quizOptions)
                                        <div class="mb-2 form-check custom-check options">
                                            <input type="checkbox"  name="quiz_option_id" value="{{ $quizOptions->id }}"
                                                        class="form-check-input quiz-check mt-2" id="{{ $quizOptions->id }}">
...
@push('scripts')
    ...
    <script src="{{ asset('js/handle_timer.js')}}" type="text/javascript"></script>
@endpush
