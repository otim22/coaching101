...
<section class="small-screen_padding">
    <div class="container">
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-12 mb-4">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h5 class="bold dark-blue_color-2">Filter by:</h5>
                        <div class="pt-3 mb-3">
                            <h6 class="bold">Subject</h6>
                            <div class="resource-filter_input">
                                <select class="custom-select" id="quiz_category">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="resource-filter_input">
                                <select class="custom-select" id="quiz_year">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="resource-filter_input">
                                <select class="custom-select" id="quiz_term">
            ...
            <div class="col-lg-10 col-md-9 col-sm-12" id="quiz_data">
                <div class="row">
                    @forelse($quizzes as $quiz)
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                            <div class="mb-3">
                                <div class="card">
                                    <div class="card-body">
                                            <a href="{{ route('student.quizzes.show', $quiz) }}" style="text-decoration: none" class="title-font">
                                                <span class="bold">{{ $quiz->title }}</span><br />
                                                <span>Questions {{ count($quiz->quizQuestions) }}</span><br />
                                            </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center mt-5">
                        <p>The quiz(s) you are looking for was not found. </p>
                    </div>
                    @endforelse
...
@push('scripts')
    ...
    <script src="{{ asset('js/student_quizzes.js')}}" type="text/javascript"></script>
@endpush
