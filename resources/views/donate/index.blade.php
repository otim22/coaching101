                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('contacts.store') }}" method="POST">
                            ...
                            <div class="collapse" id="sponsor">
                                <div class="form-group">
                                    <label for="email">Sponsee's Full Names</label>
                                    <input type="text" class="form-control" name="email" value="{{ old('email') }}" />
                                    @error('email')
                                        <div class="alert alert-danger p-2 mt-2">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group mt-4">
                                    <label for="email">Sponsee's Email Address</label>
                                    <input type="text" class="form-control" name="email" value="{{ old('email') }}" />
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="once" role="tabpanel" aria-labelledby="once-tab">
                                    <div class="pt-4">
                                        <button id="round-button-2" type="submit" class="btn btn-primary btn-block">Donate Once</button>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="monthly" role="tabpanel" aria-labelledby="monthly-tab">
                                    <div class="pt-4">
                                        <button id="round-button-2" type="submit" class="btn btn-primary btn-block">Donate Monthly</button>
                                    </div>
                                </div>
                            </div>
