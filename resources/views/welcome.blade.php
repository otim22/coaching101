        ...
        <div class="row mt-5">
            <div class="col-lg-6 col-md-8 col-sm-12">
                <div class="learn-today">
                    <h1 class="display-4 learn-today_title dark-blue_color">{{ $sliders->title }}</h1>
                    <h4 class="pt-3 bold student-font_color">{!! $sliders->description !!}</h4>
                    @guest
                    ...
                    @auth
                        @if(Auth::user()->role == 1)
                            <p><a id="round-button-2" class="btn btn-primary get-started_student mt-5" href="#learn-now" role="button">Get Started &raquo;</a></p>
                        @endif

                        @if(Auth::user()->role == 2)
                            <p><a id="round-button-2" class="btn btn-primary mt-5" href="{{ route('manage.subjects') }}" role="button">Get Started &raquo;</a></p>
                        @endif
                        @if(Auth::user()->role == 3)
                            <p><a id="round-button-2" class="btn btn-primary mt-5" href="{{ route('login') }}" role="button">Get Started &raquo;</a></p>
                        @endif
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-sm-12 col-md-4 col-lg-4 d-flex">
                <div class="mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="3.5em" height="3.5em" fill="#1d2e54" class="bi bi-cloud" viewBox="0 0 16 16">
                        <path d="M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383zm.653.757c-.757.653-1.153 1.44-1.153 2.056v.448l-.445.049C2.064 6.805 1 7.952 1 9.318 1 10.785 2.23 12 3.781 12h8.906C13.98 12 15 10.988 15 9.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 4.825 10.328 3 8 3a4.53 4.53 0 0 0-2.941 1.1z"/>
                    </svg>
                </div>
                <div>
                    <h5 class="dark-blue_color-2">Online classes</h5>
                    <p class="dark-blue_color">Discover varied topics</p>
                </div>
            </div>
            <div class="col-sm-12 col-md-4 col-lg-4 d-flex">
                <div class="mr-4">
                    <svg class="bi bi-bookmark-check" width="3em" height="3em" viewBox="0 0 16 16" fill="#1d2e54" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <h5 class="dark-blue_color-2">Expert teachers</h5>
                    <p class="dark-blue_color">Connect with right teachers</p>
                </div>
            </div>
            <div class="col-sm-12 col-md-4 col-lg-4 d-flex">
                <div class="mr-4">
                    <svg class="bi bi-clock-history" width="3em" height="3em" viewBox="0 0 16 16" fill=" #1d2e54" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <h5 class="dark-blue_color-2">Lifetime access</h5>
                    <p class="dark-blue_color">Learn on your schedule</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-12 mb-4">
                <h4 class="dark-blue_color bold"> At your own convience start learning</h4>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 mb-4">
                <h4 class="dark-blue_color bold">Mosted viewed </h4>
            </div>
...
<section class="bg-white">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="mb-2">
                    <h4 class="dark-blue_color bold">{{ $teacherImage->title }}</h4>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-9 col-md-9 col-sm-12">
                <h4 class="dark-blue_color bold">Frequently Asked Questions</h4>
            </div>
