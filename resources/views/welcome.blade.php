            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <button id="round-button-2" type="button" class="btn btn-danger btn-block" >Filter</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-sm-12 col-md-4 col-lg-4 d-flex">
                <div class="mr-4">
                    <svg class="bi bi-cloud-fill" width="3em" height="3em" viewBox="0 0 16 16" fill="gray" xmlns="http://www.w3.org/2000/svg">
