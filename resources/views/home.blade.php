    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12">
                <div class="d-flex">
                    <div class="mr-4">
                        <svg class="bi bi-collection-play" width="4em" height="4em" viewBox="0 0 16 16" fill="#1d2e54" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        <h4 class="dark-blue_color bold">Teach students online</h4>
                        <p class="dark-blue_color">Top teachers from best schools teaching millions of students on Coaching101.</p>
                    </div>
                </div>
            </div>
