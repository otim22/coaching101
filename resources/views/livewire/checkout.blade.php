    ...
    <div class="row">
        <div class="col-lg-8 col-md-12 col-sm-12 rounded mb-5">
            ...
            <div wire:ignore class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active nav-card" id="nav-card" role="tabpanel" aria-labelledby="nav-card-tab">
                    <div class="bg-white add-shadow rounded p-5">
                        <p id="please-text">Please, Provide Card Details (International)</p>
                        ...
                        <div class="secure-badge" id="flutterwave-badge">
                ...
                <div class="tab-pane fade nav-mobilemoney" id="nav-mobilemoney" role="tabpanel" aria-labelledby="nav-mobilemoney-tab">
                    <div class="bg-white add-shadow rounded p-5">
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('livewire:load', function (event) {
            var spinnerCard = $('.nav-card').find('#spinner')
            var spinnerMobilemoney = $('.nav-mobilemoney').find('#spinner')
            var alert = $('#alert')
            var myCard = $('#my-card');
            var proccessBtn = $('#process')
            var alertSuccess = $('#alert-success')
            var pleaseText = $('#please-text')
            var flutterwaveBadge = $('#flutterwave-badge')

            spinnerCard.attr("style","display:none !important");
            spinnerMobilemoney.attr("style","display:none !important");
            ...
            function processCardPayment () {
                ...
                proccessBtn.addClass('disabled')
                myCard.attr("style","display: none !important")
                flutterwaveBadge.attr("style","display: none !important")
                spinnerCard.removeAttr('style')
                pleaseText.attr("style","display: none !important")
            ...
            $("#process").click(function() {
                if ($('.nav-link').hasClass('active')) {
                    ...
                    if (tab === 'nav-mobilemoney-tab') {
                        ...
                        spinnerMobilemoney.removeAttr('style')
                        pleaseText.attr("style","display: none !important")
            ...
            if ($('.nav-link').hasClass('active')) {
                ...
                if (tab === 'nav-mobilemoney-tab') {
                    ...
                    spinnerMobilemoney.attr("style","display:none !important")
                    proccessBtn.removeClass('disabled')
                }
            }
