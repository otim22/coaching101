    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-8">
                <div class="border mr-2 p-4 rounded bg-gray mb-5">
                    ...
                    <ul>
                        @foreach($course->options['students_learn'] as $student_learn)
                        <li>
                ...
                <div class="mb-5">
                    <h4>Requirements</h4>
                    <ul>
                        @foreach($course->options['class_requirement'] as $class_requirement)
                        <li>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 mb-4">
                <aside class="p-3 p-4 border rounded bg-white add-shadow">
                    <div class="make-me-sticky">
                        <div class="mb-3">
                            <a class="btn btn-danger btn-block" href="#">Go to course</a>
                        </div>
        ...
        <div class="row">
            <div class="col-12 mb-3">
                <h4> More courses by Otim fredrick</h4>
            </div>
