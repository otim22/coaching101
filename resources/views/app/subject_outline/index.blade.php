<div class="fast-transition mb-3">
    ...
    <div class="row m-2">
        <div class="">
            <form class="subject_outline_form" action="{{ url('subject_outline_submission') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="clone col-sm-12 col-md-12 col-lg-12">
                    <div class="card card-body mb-5">
                        <div class="form-group">
                            <div class="float-right">
                                <button type="button" class="btn btn-secondary btn-sm remove_topic">
                                    <span class="mr-1">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 mt-5 mb-4">
                <div class="d-flex justify-content-end">
                    <div>
                        <p type="button" class="btn_add_topic">
                            <span class="mr-1 ">
