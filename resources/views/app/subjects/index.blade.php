        ...
        <div class="row">
          ...
          <div class="col-9">
            <div class="tab-content" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade" id="v-pills-subject-structure" role="tabpanel" aria-labelledby="v-pills-subject-structure-tab">Subject structure</div>
              <div class="tab-pane fade" id="v-pills-film-edit" role="tabpanel" aria-labelledby="v-pills-film-edit-tab">Film & edit</div>
              <div class="tab-pane fade" id="v-pills-subject-outline" role="tabpanel" aria-labelledby="v-pills-subject-outline-tab">Subject outline</div>
              <div class="tab-pane fade" id="v-pills-target-students" role="tabpanel" aria-labelledby="v-pills-target-students-tab">Target your students</div>
              <div class="tab-pane fade" id="v-pills-subject-messages" role="tabpanel" aria-labelledby="v-pills-subject-messages-tab">Subject messages</div>
            </div>
          </div>
        </div>
    </div>
