<div class="fast-transition mb-3">
    ...
    <div class="row m-2">
        <div class="">
            <form class="subject_outline_form" action="{{ url('subjects') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="clone col-sm-12 col-md-12 col-lg-12">
                    <div class="card card-body mb-5">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" id="content_description" rows="3" class="form-control @error('content_description') is-invalid @enderror" placeholder="Include a description. What students will be able to do after completing the class." value="{{ old('content_description') }}" name="content_description"></textarea>
