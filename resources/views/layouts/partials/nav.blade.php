    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto nav nav-pills">
                ...
                <li id="cartId2" class="nav-item {{ Helper::set_active(['register']) }} mt-1">
                ...
                <li class="nav-item {{ Helper::set_active(['login']) }} mt-1 mr-2">
                    <button class="btn btn-outline-primary btn-sm nav-link pl-3 pr-3" href="{{ route('login') }}">Login</button>
                </li>
                @if (Route::has('register'))
                    <li class="nav-item {{ Helper::set_active(['register']) }} mt-1">
                        <button class="btn btn-outline-secondary btn-sm nav-link pl-2 pr-2" href="{{ route('register') }}">Register</button>
                    </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="{{ route('edit-credit-card') }}">Purchase history</a>
