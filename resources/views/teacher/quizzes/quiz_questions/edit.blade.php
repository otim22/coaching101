            ...
            <div class="col-lg-10 col-md-12 col-sm-12 off-set-1">
                <div class="card p-3">
                    <div class="card-body">
                        ...
                        <form action="{{ route('quizQuestions.update', [$quiz, $quizQuestion]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            <div class="form-group">
                                ...
                                <input type="text" name="quiz_question"
                                            ...
                                            value="{{ old('quiz_question', $quizQuestion->quiz_question) }}">
                                @error('quiz_question')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control @error('answer_explanation') is-invalid @enderror"
                                                        ...
                                                        rows="3"
                                                        required>{{ old('answer_explanation', $quizQuestion->answer_explanation) }}</textarea>
                                </div>
