    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 col-md-12 col-sm-12 off-set-1">
                <div class="card p-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                            <div>
                                <a id="round-button-2" href="{{ route('qizzes.show', $quiz) }}" class="btn btn-secondary">
                ...
                <form action="{{ route('quizzes.delete', $quiz) }}" class="hidden" id="delete-teacher-subpastpapers" method="POST">
                    @csrf
                    @method('delete')
                </form>
            </div>
