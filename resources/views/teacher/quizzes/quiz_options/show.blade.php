...
<section class="small-screen_padding">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 col-md-12 col-sm-12 off-set-1">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="{{ route('quizOptions.edit', [$quiz, $quizQuestion, $quizOption]) }}">
                                    ...
                                    <a class="dropdown-item" href="#"
                                            data-toggle="modal" data-target="#deleteQuizOptions">
                ...
                <form action="{{ route('quizOptions.delete', [$quiz, $quizQuestion, $quizOption]) }}" class="hidden" id="delete-teacher-quiz-option" method="POST">
                    @csrf
                    @method('delete')
                </form>
            </div>
    ...
    <div class="modal fade" id="deleteQuizOptions" tabindex="-1" aria-labelledby="deleteQuizOptionsLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteQuizLabel">{{ $quizOption->option }}</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button  id="round-button-2" type="button" class="btn btn-sm btn-danger" onclick="event.preventDefault(); document.getElementById('delete-teacher-quiz-option').submit();">Delete</button>
                </div>
            </div>
        </div>
    </div>
