...
<section id="section-teacher_course" class="{{ (count($subjects) == 0) ? 'hide-me' : 'bg-white' }} small-screen_padding">
    <div class="container">
        <div class="row">
                            ...
                            <div class="card-body">
                                @if($pastpaper->isSubscribedTo)
                                    <a href="{{ route('student.pastpapers.show', $pastpaper) }}" style="text-decoration: none" class="title-font">
                                        ...
                                        @if($pastpaper->price)
                                            {{ $pastpaper->currency->name }} {{ $pastpaper->formatPrice }}/- <span class="author-font">(Paid)</span>
                                        @else
                                            <span class="bold paid_color">Free</span>
                                        @endif
                                    </a>
