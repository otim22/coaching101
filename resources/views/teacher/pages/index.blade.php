...
<body>
    <div id="app">
        ...
        <section class="bg-dark text-white one">
            <div class="mt-5">
                <div class="container">
                    <h1 class="display-3">Inspire students</h1>
                    ...
                    <p>
                        @if(Auth::user()->role == 1)
                            <a class="btn btn-primary btn-lg mt-5" href="{{ route('subjects.start') }}" role="button">Become a teacher &raquo;</a>
                        @elseif(Auth::user()->role == 2)
                            <a class="btn btn-primary btn-lg mt-5" href="{{ route('manage.subjects') }}" role="button">Become a teacher &raquo;</a>
                        @endif
                    </p>
                </div>
            </div>
    ...
    <section class="five bg-gray">
        <div>
            <div class="container">
                <div class="row text-center">
                    <div class="col-12 text-center">
                        <h1>Become a techer today.</h1>
                        <h5 class="mb-3 mt-3">This is a template for a simple marketing or informational website.</h5>
                        <a type="button" href="{{ route('manage.subjects') }}"class="btn btn-primary" name="button">Get started</a>
                    </div>
                </div>
            </div>
        </div>
