    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Create Notes</li>
            </ol>
        </nav>
    </div>
</section>
                ...
                <div class="card p-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h5 class="bold">New Notes</h5>
                            </div>
                            <div>
                                <a id="round-button-2" href="{{ route('teacher.notes') }}" class="btn btn-secondary">
