                        ...
                        <div id="ocl_pdf_viewer">
                            ...
                            <div class="d-flex justify-content-between mt-4 mb-3">
                                <div id="navigation_controls">
                                    <button id="go_previous" class="btn btn-secondary">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
                                        </svg>
                                    </button>
                                    <input id="current_page" value="1" class="current-page ml-1 mr-1"  type="number" />
                                    <button id="go_next" class="btn btn-secondary">
                                ...
                                <div id="zoom_controls">
                                    <button id="zoom_in" class="btn btn-secondary mr-1">
...
@push('scripts')
    ...
    <script src="{{ asset('js/custom_pdf_view.js')}}" type="text/javascript"></script>
@endpush
