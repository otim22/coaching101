                ...
                <div class="card p-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                            <div>
                                <a  id="round-button-2" href="{{ route('manage.subjects') }}" class="btn btn-secondary">
                            ...
                            <div>
                                <a  id="round-button-2" href="{{ route('notes.create') }}" class="btn btn-primary">
                        ...
                        <ul class="mt-4 mb-3">
                            @forelse($notes as $note)
                                <div>
                                    <a href="{{ route('notes.show', $note) }}" style="text-decoration: none;">
                                        <li class="mb-2">
