                ...
                <div class="card p-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <div>
                                <a id="round-button-2" href="{{ route('exams.show', $exam) }}" class="btn btn-secondary">
                        ...
                        <form action="{{ route('examQuestions.store', $exam) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="exam_question">Exam question</label>
                                <input type="text" name="exam_question" class="form-control @error('exam_question') is-invalid @enderror" placeholder="Example: Introduction to relativity" value="{{ old('exam_question') }}">
                                @error('exam_question')
