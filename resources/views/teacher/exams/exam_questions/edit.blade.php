                ...
                <div class="card p-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                            <div>
                                <h5 class="bold">New exam question</h5>
                            </div>
                            <div>
                        ...
                        <form action="{{ route('examQuestions.update', [$exam, $examQuestion]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            <div class="form-group">
                                <label for="exam_question">Exam question</label>
                                <input type="text" name="exam_question"
                                            class="form-control @error('exam_question') is-invalid @enderror"
                                            value="{{ old('exam_question', $examQuestion->exam_question) }}">
                                @error('exam_question')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control @error('answer_explanation') is-invalid @enderror"
                                                        ...
                                                        rows="3"
                                                        required>{{ old('answer_explanation', $examQuestion->answer_explanation) }}</textarea>
                                </div>
