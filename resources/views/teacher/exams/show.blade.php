    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-12 col-sm-12">
                <div class="fast-transition">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('examQuestions.create', $exam)}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('exams.edit', $exam) }}">
                        ...
                        <li class="nav-item">
                            <a type="button" class="nav-link" href="#" data-toggle="modal" data-target="#deleteExam">
                        ...
                        <div class="ml-3">
                            <li class="nav-item mb-3">
                                <span>
                                    ...
                                    {{ $exam->itemContent->standard->name }}
                                </span>
                            </li>
                            ...
                            <li class="nav-item mb-2">
                                <span>
                                    ...
                                    {{ $exam->itemContent->category->name }}
                                </span>
                            </li>
                            <li class="nav-item mb-2">
                                <span>
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 adds-padding upper-padding">
                <h5 class="bold mb-3">{{ $exam->title }}</h5>
                <div class="mb-3">
                    <ul>
                        @forelse($exam->examQuestions as $key => $examQuestion)
                            <li class="mb-2">
                                <a href="{{ route('examQuestions.show', [$exam, $examQuestion]) }}" style="text-decoration:none;">
                                    {{ $key+1 }}. {{ $examQuestion->exam_question }}
                                </a>
                            </li>
                        @empty
                            <p>No exams</p>
            ...
            <form action="{{ route('exams.destroy', $exam) }}" class="hidden" id="delete-teacher-exam" method="POST">
                @csrf
                @method('delete')
            </form>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteExamLabel">{{ $exam->title }}</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button  id="round-button-2" type="button" class="btn btn-sm btn-danger" onclick="event.preventDefault(); document.getElementById('delete-teacher-exam').submit();">Delete</button>
                </div>
            </div>
        </div>
    </div>
